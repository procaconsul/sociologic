...
queue(queue1, 5,  1..14, agent6).
queue(queue1, 6,  1..14, agent7).
queue(queue1, 7,  1..14, agent8).
queue(queue1, 8,  1..14, agent9).
queue(queue1, 9,  1..14, agent10).
queue(queue1, 10, 1..14, agent11).
queue(queue1, 11, 1..14, agent12).
queue(queue1, 12, 1..14, agent13).
queue(queue1, 13, 1..14, agent14).
queue(queue1, 14, 1..14, agent15).
...
queue(queue1, 2, 1..14, agent2).
queue(queue1, 3, 1..14, agent3).
queue(queue1, 4, 1..14, agent4).
queue(queue1, 5, 1..14, agent5).
