...
o_point(p2_3, "29.553", "11.000", "180.0"). 
o_point(p2_4, "27.000", "11.000", "180.0").
o_point(p2_5,  "25.000", "11.000", "180.0").
...
o_point(p2_1, "20.051", "11.000", "0.0").
o_point(p2_2, "22.051", "11.000", "0.0").
o_point(p2_3, "24.050", "11.000", "0.0"). 
o_point(p2_4, "26.501", "11.000", "0.0").
o_point(p2_5, "24.501", "11.000", "180.0").
o_point(p2_6, "22.051", "11.000", "180.0").
o_point(p2_7, "20.051", "11.000", "180.0").
o_point(p2_8, "18.051", "11.000", "180.0").
o_point(p2_9, "16.051", "11.000", "140.0").
o_point(p2_10, "14.051", "12.000", "290.0").
o_point(p2_11, "16.051", "11.000", "0.0").
o_point(p2_12, "18.051", "11.000", "0.0").
}).
...
o_point(p2_8, "19.000", "11.000", "180.0").
o_point(p2_9, "17.000", "11.000", "180.0").
o_point(p2_10, "15.000", "11.000", "190.0").
o_point(p2_11, "13.000", "11.000", "190.0").
o_point(p2_12, "13.000", "11.000", "190.0").
o_point(p2_13, "13.000", "11.000", "190.0").
o_point(p2_14, "11.000", "11.800", "200.0").
o_point(p2_15, "09.000", "11.000", "180.0").
o_point(p2_16, "07.000", "11.000", "180.0").
o_point(p2_17, "05.000", "11.000", "180.0").
o_point(p2_18, "03.000", "11.000", "180.0").
...
o_point(p2_3, "29.500", "11.000", "180.0"). 
o_point(p2_4, "30.501", "11.000", "45.0").
o_point(p2_5, "31.501", "12.000", "220.0").
o_point(p2_6, "31.051", "12.000", "220.0").
o_point(p2_7, "31.051", "12.000", "220.0").
o_point(p2_8, "29.051", "11.000", "180.0").
o_point(p2_9, "27.051", "11.000", "180.0").
o_point(p2_10, "25.051", "11.000", "180.0").
o_point(p2_11, "23.051", "11.000", "180.0").
o_point(p2_12, "21.051", "11.000", "180.0").
}).
...
% % ######################################
% % REINFORCEMENT EXAMPLES FOR PREFERENCES 
% % BETWEEN SCENARIOS
% % ######################################

% #pos(p1_r_1vs2_squeeze, {}, {}, {
...
% % agent 2 steps aside and squeezes by wall 
% % BEFORE mid-corridor
% pos(agent1, 1, p1_1).
% pos(agent1, 2, p1_2).
% pos(agent1, 3, p1_3).
...
% o_point(p1_1, "21.051", "11.080", "0.0").
% o_point(p1_2, "24.051", "11.080", "0.0").
% o_point(p1_3, "26.051", "11.000", "0.0"). 
% o_point(p1_4, "28.051", "11.000", "0.0").

% o_point(p2_1, "27.553", "11.910", "180.0"). 
% o_point(p2_2, "26.553", "11.910", "180.0"). 
% o_point(p2_3, "25.000", "11.110", "180.0").
% o_point(p2_4, "21.000", "11.300", "220.0").
% }).

% #pos(p2_r_1vs2_squeeze, {}, {}, {
...
% % agent 1 steps and squeezes by the wall 
% % AFTER passing the mid-point of the corridor
% pos(agent1, 1, p1_1).
% pos(agent1, 2, p1_2).
% pos(agent1, 3, p1_3).
% pos(agent1, 4, p1_4).
...
% o_point(p1_3, "30.500", "11.000", "180.0"). 
% o_point(p1_4, "29.501", "11.000", "180.0").
% o_point(p1_5, "28.501", "11.000", "180.0").
% o_point(p1_6, "27.051", "11.000", "180.0").
% o_point(p1_7, "26.051", "11.000", "180.0").
% o_point(p1_8, "22.051", "11.000", "180.0").
% o_point(p1_9, "20.051", "11.000", "180.0").

% o_point(p2_1, "20.051", "11.000", "0.0").
% o_point(p2_2, "22.051", "11.000", "0.0").
% o_point(p2_3, "24.050", "11.000", "0.0"). 
% o_point(p2_4, "25.501", "11.800", "40.0").
% o_point(p2_5, "27.501", "11.910", "0.0").
% o_point(p2_6, "29.051", "11.910", "0.0").
% o_point(p2_7, "31.051", "11.000", "0.0").
% o_point(p2_8, "31.051", "11.000", "0.0").
% o_point(p2_9, "31.051", "11.000", "0.0").

% }).


% #pos(p2_r_1vs2_squeeze_bis, {}, {}, {
...
% o_point(p1_1, "15.051", "11.000", "0.0").
% o_point(p1_2, "17.051", "11.000", "0.0").
% o_point(p1_3, "19.050", "11.000", "0.0"). 
% o_point(p1_4, "20.501", "11.100", "40.0").
% o_point(p1_5, "22.601", "11.910", "0.0").
% o_point(p1_6, "24.051", "11.910", "0.0").
% o_point(p1_7, "26.051", "11.000", "0.0").
                                            
% % o_point(p2_1, "27.051", "11.000", "180.0").
% % o_point(p2_2, "26.051", "11.000", "180.0").
% % o_point(p2_3, "25.500", "11.000", "180.0"). 
% % o_point(p2_4, "24.501", "11.000", "180.0").
% % o_point(p2_5, "23.501", "11.000", "180.0").
% % o_point(p2_6, "22.051", "11.000", "180.0").
% % o_point(p2_7, "21.051", "11.000", "180.0").
...
% point(w1_e, "25.0", "12.0").

% % wall 2 
% wall(wall2, w2_s, w2_e).
% point(w2_s, "10.0", "10.0").
% point(w2_e, "25.0", "10.0").
